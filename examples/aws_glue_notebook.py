...
MY_S3_BUCKET_OUTPUT_PATH = "s3://meta-overture-staging/transportation_splitter/{OVERTURE_RELEASE_VERSION}/colorado"
...
wrangler = SplitterDataWrangler(
    input_path=f"s3://overturemaps-us-west-2/{OVERTURE_RELEASE_VERSION}/theme=transportation/",
    output_path=MY_S3_BUCKET_OUTPUT_PATH.format(OVERTURE_RELEASE_VERSION),
